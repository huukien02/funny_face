...
function CmtPopup(props) {
  ...
  const handleOk = async () => {
    try {
      ...
      const response = await axios.post(
        "https://databaseswap.mangasocial.online/report/comment",
        {
  ...
  const updateComment = async () => {
    try {
      const response = await axios.patch(
        `https://databaseswap.mangasocial.online/lovehistory/edit/${editingCommentId}`,
  ...
  const deleteComment = async (idComment) => {
    try {
      const response = await axios.delete(
        `https://databaseswap.mangasocial.online/lovehistory/delete/${idComment}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const fetchDataCmt = async () => {
    ...
    try {
      const response = await axios.get(
        `https://databaseswap.mangasocial.online/lovehistory/comment/${props.data.so_thu_tu_su_kien}?id_toan_bo_su_kien=${param.id}&id_user=${idUser}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const HandleSendCmt = async (e) => {
    ...
    const url = "https://databaseswap.mangasocial.online/lovehistory/comment";
    let comment = {};
    let comment2 = {};
